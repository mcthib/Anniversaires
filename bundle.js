...
},{"./lunisolar.js":2}],2:[function(require,module,exports){
(function()
{
  ...
  this.GetGregorianFromLunisolar = function($lunisolarDate, useLeapMonth)
    {
      // Year
      var lunisolarYear = $lunisolarDate.getFullYear();
      
      // Check if we're in range
      if ((lunisolarYear < YEAR_MIN) || (lunisolarYear > YEAR_MAX))
      {
        return null;
      }
    ...
    // 'isLeapMonth' members.
  this.GetLunisolarFromGregorian = function($gregorianDate)
    {
      ...
      // Check if we're in range
      if ((gregorianYear < YEAR_MIN) || (gregorianYear > YEAR_MAX))
      {
        return null;
      }
